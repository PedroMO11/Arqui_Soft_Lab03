...
| A sender can send from the app, the website, or a branch | Matches how a real remittance service works. The app and web reach senders who have a bank account or card; the branch reaches senders who want to pay cash |
